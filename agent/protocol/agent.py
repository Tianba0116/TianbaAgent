...
class Agent:
    ...
    def run_stream(self, user_message: str, on_event=None, clear_history: bool = False,
                   skill_filter=None, confirmation_handler=None) -> str:
        """
        ...
        Args:
            ...
            clear_history: If True, clear conversation history before this call
        ...
        executor.confirmation_handler = confirmation_handler
