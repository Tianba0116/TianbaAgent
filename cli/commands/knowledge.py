"""tianba knowledge - Knowledge base management commands."""
...
def _get_knowledge_dir():
    ...
    try:
        ...
        workspace = expand_path(conf().get("agent_workspace", "~/tianba"))
    except Exception:
        workspace = os.path.expanduser("~/tianba")
...
@click.pass_context
def knowledge(ctx):
    """Manage TianbaAgent knowledge base."""
